	...
	return (
		<div
			...
			className={cn(
				...
				// --- ИСПРАВЛЕНИЕ КУРСОРА ---
				// touch-none: важно для dnd-kit на сенсорных экранах
				// select-none: запрещает выделение текста, чтобы курсор не менялся на текстовый
				// cursor-grab: рука при наведении
				// active:cursor-grabbing: сжатая рука при нажатии
				'touch-none select-none cursor-grab active:cursor-grabbing',

				// Стили для оверлея (когда тащим) и обычного состояния
				isOverlay
